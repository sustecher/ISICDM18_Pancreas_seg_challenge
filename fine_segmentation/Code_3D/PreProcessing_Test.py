...
root_path='/home/bisp/dir/Pancreas_ISICDM_2020/'
data_path = '/home/bisp/dir/raw_data/ISICDM_2018/Test/'
save_path='/home/bisp/dir/Pancreas_ISICDM_2020/Code_3D/Test/'
...
def Demo_Test():
    ...
    for l in range(num_patient):
        ...
        Min_z = int(Crop_Range[l, 0])
        Min_x = int(Crop_Range[l, 1])
        Min_y = int(Crop_Range[l, 2])
        Max_z = int(Crop_Range[l, 3])
        Max_x = int(Crop_Range[l, 4])
        Max_y = int(Crop_Range[l, 5])
        ...
        sheet.write(row_num, 4, Max_z)
        sheet.write(row_num, 5, Max_x)
        sheet.write(row_num, 6, Max_y)
        ...
        sheet.write(row_num, 8, Min_z)
        sheet.write(row_num, 9, Min_x)
        sheet.write(row_num, 10, Min_y)
        sheet.write(row_num, 11, Max_z)
        sheet.write(row_num, 12, Max_x)
        sheet.write(row_num, 13, Max_y)
    ...
    book.save(save_path+'SameDirectionParameters.xls')
